...
extension UITextField {
    ...
    func setPlaceHolderColor(txtString: String){
        self.attributedPlaceholder = NSAttributedString(string: txtString, attributes: [NSAttributedStringKey.foregroundColor : AppInfo.PlaceHolderColor])
...
extension GMSMapView {
    func setRegion(sourceLocation: CLLocationCoordinate2D, zoomLevel : Float = 12.0)  {
